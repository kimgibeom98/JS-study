...
console.log(solution([1,2,3,4,5], mapeven, filtereven));

// exp.4  0부터 9까지의 숫자 중 일부가 들어있는 정수 배열 numbers가 매개변수로 주어진다. 
// numbers에서 찾을 수 없는 0부터 9까지의 숫자를 모두 찾아 더한 수를 return 하도록 solution 함수를 완성해라.
// for문 사용
...
function solution(arr){
   const total = 0;
   const datasum = 45 - arr.reduce((acc, dcr) => acc + dcr, total)
   return datasum;
}
